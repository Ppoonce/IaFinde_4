...
export const rankings: Ranking[] = [
  {
    ...
    intro:
      'Este ranking recoge las herramientas mejor valoradas de todo el directorio, según nuestra valoración editorial independiente. Es un criterio propio del equipo de IAFinder, no una encuesta a usuarios ni una medición de tráfico externo, y se revisa periódicamente a medida que probamos más herramientas.',
    faqs: [
      {
