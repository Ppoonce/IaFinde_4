...
export default function ToolsDirectory() {
  // Importante para SEO: el listado completo se renderiza siempre, sin
  // depender de leer parámetros de la URL antes de pintar contenido (eso
  // haría que Google solo viera un estado de "Cargando…" en la versión
  // estática). El parámetro ?q= de la búsqueda desde el inicio se aplica
  // después, como mejora progresiva, leyendo window.location directamente
  // en vez de useSearchParams (que en la exportación estática obliga a
  // mostrar el estado de carga como contenido "real").
