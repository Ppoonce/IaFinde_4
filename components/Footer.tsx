  ...
  return (
    <footer className="border-t border-line bg-surface">
      <div className="mx-auto grid max-w-6xl gap-10 px-5 py-14 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2">
            ...
            <li><Link href="/mejores-ias" className="text-sm text-inkmuted hover:text-signal">Mejores IA</Link></li>
            <li><Link href="/mejores-ias-gratis" className="text-sm text-inkmuted hover:text-signal">Mejores IA gratis</Link></li>
      ...
      <div className="border-t border-line px-5 py-6 text-center text-xs text-inkmuted">
        <p>© {new Date().getFullYear()} IAFinder. Directorio editorial independiente de herramientas de inteligencia artificial.</p>
        <p className="mt-1">
          Algunos enlaces hacia herramientas de terceros pueden ser enlaces de afiliado — más información en nuestra{' '}
          <Link href="/politica-de-privacidad" className="underline hover:text-signal">
