...
export default function HomePage() {
  const homeSections = [
    ...
    { emoji: '⭐', title: 'Mejor valoradas', subtitle: 'Según nuestra valoración editorial (demo).', tools: getTopRatedTools(6), href: '/mejores-ias' },
  ...
  return (
    <>
      ...
      {homeSections.map((section, i) => (
        <section key={section.title} className="mx-auto max-w-6xl px-5 pb-16">
